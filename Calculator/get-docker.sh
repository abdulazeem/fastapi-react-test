#!/bin/sh
set -e
# Dockerfile Engine for Linux installation script.
#
# This script is intended as a convenient way to configure docker's package
# repositories and to install Dockerfile Engine, This script is not recommended
...
# - Installs the latest stable release (by default) of Dockerfile CLI, Dockerfile Engine,
#   Dockerfile Buildx, Dockerfile Compose, containerd, and runc. When using this script
#   to provision a machine, this may result in unexpected major version upgrades
#   of these packages. Always test upgrades in a test environment before
#   deploying to your production systems.
# - Isn't designed to upgrade an existing Dockerfile installation. When using the
...
# ==============================================================================
#
# To install the latest stable versions of Dockerfile CLI, Dockerfile Engine, and their
# dependencies:
#
